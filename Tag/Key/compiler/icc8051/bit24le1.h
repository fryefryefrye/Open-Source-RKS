 ...
 * bit24le1.h
 *
 * IAR ICC8051 bit definition file for the Nordic Semiconductor nRF24LE1
...
#define MISC    IEN1_bit.MISC
#define WUPIN   IEN1_bit.WUPIN
...
#define MISCF   IRCON_bit.MISCF
#define WUPINF  IRCON_bit.WUPINF
