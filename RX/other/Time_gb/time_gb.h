...
void WeatherCode2ChartIndex2(unsigned char Code,unsigned char * ChartIndex)
{
	...
	case 7://小雨	Light Rain	小雨
	case 21:
		ChartIndex[0] = XIAO;
		ChartIndex[1] = YU;
		break;

	case 8://中雨	Moderate Rain	中雨
	case 22:
		ChartIndex[0] = ZHONG;
		ChartIndex[1] = YU;
		break;

	case 9://大雨	Heavy Rain	大雨
	case 23:
		ChartIndex[0] = DA;
		ChartIndex[1] = YU;
		break;
	...
	case 10://暴雨	Storm	暴雨
	case 11://暴雨	Heavy Storm	大暴雨
	case 12://暴雨	Severe Storm	特大暴雨
	case 24:
	case 25:
		ChartIndex[0] = BAO;
		ChartIndex[1] = YU;
	...
	case 13://阵雪	Snow Flurry	阵雪
		ChartIndex[0] = ZHEN;
		ChartIndex[1] = XUE;
		break;

	case 14://小雪	Light Snow	小雪
	case 26:
		ChartIndex[0] = XIAO;
		ChartIndex[1] = XUE;
		break;

	case 15://中雪	Moderate Snow	中雪
	case 27:
		ChartIndex[0] = ZHONG;
		ChartIndex[1] = XUE;
		break;

	case 16://大雪	Heavy Snow	大雪
	case 28:
		ChartIndex[0] = DA;
		ChartIndex[1] = XUE;
		break;

	case 17://	暴雪	Snowstorm	暴雪
		ChartIndex[0] = BAO;
		ChartIndex[1] = XUE;
		break;
